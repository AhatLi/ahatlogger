...
public:
	...
	AhatLogItemDBError(std::string src_file, InDBtem db_req_item, std::string db_res_body);
	std::string message()
	{
		std::stringstream buf;
		buf << "," << src_file << "," << std::this_thread::get_id() << "," << db_req_item.db_req_time << "," << db_res_time 
...
public:
	...
	AhatLogItemInReqError(std::string src_file, InReqItem in_req_item, std::string in_res_body);
	std::string message()
	{
		std::stringstream buf;
		buf << "," << src_file << "," << std::this_thread::get_id() << "," << in_req_item.in_req_ip << "," << in_req_item.in_req_port 
